    ...
    <section class="bg-white py-8 dark:bg-gray-900 lg:py-16">
      <div class=" max-w-2xl px-4">
        ...
        <form class="mb-6">
          ...
          <button
            type="submit"
            class="bg-primary-700 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800 inline-flex max-h-64 items-center rounded-lg py-2.5 px-4 text-center text-xs font-medium text-white focus:ring-4"
          >
            Comment
          </button>
        </form>
